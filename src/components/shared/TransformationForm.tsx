      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            ...
            <Select onValueChange={(value)=>onSelectFieldHandler(value,field.onchange)} value={field.Value} >
              ...
              <SelectContent>
                {Object.keys(aspectRatioOptions).map((key)=>(
                  <SelectItem key={key} value={key} className="selct-item">
        ...
        {(type==='remove'||type==="recolor")&&(
          <div className="prompt-field">
            ...
            {type==='recolor'&&(
              <CustomField control={form.control} name="color" formLabel="Replacment color" className="w-full" render={({field})=>(
            ...
            <div className="media-uploader-field">
              <CustomField control={form.control} name="publicId" className="flex size-full fle-col" render={({field})=>(
